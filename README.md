...
through a bit of a design process and produce a consensus among the Ember CLI
core team.

The "RFC" (request for comments) process is intended to provide a
consistent and controlled path for new features to enter the tool.

[Active RFC List](https://github.com/ember-cli/rfcs/pulls)

## When you need to follow this process

You need to follow this process if you intend to make "substantial"
changes to Ember CLI or its documentation. What constitutes a
...
include the following.
   ...
   - The introduction of new idiomatic usage or conventions, even if they
     do not include code changes to Ember CLI itself.
...
criteria (speedup, better browser support)
   - Additions only likely to be _noticed by_ other implementors-of-Ember CLI,
invisible to users-of-Ember CLI.
...
In short, to get a major feature added to Ember CLI, one must first get the
RFC merged into the RFC repo as a markdown file. At that point the RFC
is 'active' and may be implemented with the goal of eventual inclusion
into Ember CLI.

* Fork the RFC repo http://github.com/ember-cli/rfcs
...
* Find a champion on the ember-cli core team. Without a champion, the RFC will not progress.
* Build consensus and integrate feedback. RFCs that have broad support
are much more likely to make progress than those that don't receive any
comments.
* Eventually, the [core team] will decide whether the RFC is a candidate
for inclusion in Ember CLI.
* RFCs that are candidates for inclusion in Ember CLI will enter a "final comment
...
feature as a pull request to the Ember CLI repo. Becoming 'active' is not a rubber
...
Thursday team meeting, and reported in [core team notes]. Every
